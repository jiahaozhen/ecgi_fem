...
v_data_ischemia, _, _ = compute_v_based_on_reaction_diffusion(mesh_file, ischemia_flag=True, T=T, u_peak_ischemia_val=0.9, u_rest_ischemia_val=0.1, step_per_timeframe=step_per_timeframe)
...
d_data_ischemia = compute_d_from_tmp(mesh_file, v_data_ischemia)
