...
def adaboost_lmt_classifier(X_train, y_train):
	estimator = LogisticRegression(max_iter=1000, solver='lbfgs')
	clf = AdaBoostClassifier(estimator=estimator, n_estimators=50, algorithm='SAMME')
...
if __name__ == '__main__':
	...
	clf = adaboost_lmt_classifier(X_train, y_train)
