...
if __name__ == "__main__":
    ...
    save_dir = 'machine_learning/data/dataset_dl/d12_standard_dataset'
    d_data_dir = 'machine_learning/data/dataset_dl/d_dataset'

    # save_dir = 'machine_learning/data/dataset_ml/d12_standard_dataset'
    ...
    for file_idx, file in enumerate(d_data_files):
        ...
        for i, (d, seg_id) in enumerate(zip(d_data, seg_ids)):
            try:
                standard_d = transfer_bsp_to_standard12lead(d)
